...
class Sanction(commands.Cog):
	...
	async def sanction(self, ctx, sanction_type, user : discord.User):
		...
		if sanction_type == "warn":
			...
			em2 = discord.Embed(title = f"Liste des warns de {user.name}", description = f"> • Warn le **{jour_1}/{mois_1}/{annee_1}** à *{heure_1}h{minute_1}* pour **{sanction_1}**", color = 0xFF6C00)
			em3 = discord.Embed(title = f"Liste des warns de {user.name}", description = f"> • Warn le **{jour_1}/{mois_1}/{annee_1}** à *{heure_1}h{minute_1}* pour **{sanction_1}** \n > • Warn le **{jour_2}/{mois_2}/{annee_2}** à *{heure_2}h{minute_2}* pour **{sanction_2}**", color = 0xFF6C00)
			...
			em2 = discord.Embed(title = f"Liste des mutes de {user.name}", description = f"> • Mute le **{jour_1}/{mois_1}/{annee_1}** à *{heure_1}h{minute_1}* pendant ***{duree_1}*** pour **{sanction_1}**", color = 0xFF6C00)
			em3 = discord.Embed(title = f"Liste des warns de {user.name}", description = f"> • Mute le **{jour_1}/{mois_1}/{annee_1}** à *{heure_1}h{minute_1}* pendant ***{duree_1}*** pour **{sanction_1}** \n > • Mute le **{jour_2}/{mois_2}/{annee_2}** à *{heure_2}h{minute_2}* pendant ***{duree_2}*** pour **{sanction_2}**", color = 0xFF6C00)
			...
			em2 = discord.Embed(title = f"Liste des kicks de {user.name}", description = f"> • Kick le **{jour_1}/{mois_1}/{annee_1}** à *{heure_1}h{minute_1}* pour **{sanction_1}**", color = 0xFF6C00)
			em3 = discord.Embed(title = f"Liste des warns de {user.name}", description = f"> • Kick le **{jour_1}/{mois_1}/{annee_1}** à *{heure_1}h{minute_1}* pour **{sanction_1}** \n > • Kick le **{jour_2}/{mois_2}/{annee_2}** à *{heure_2}h{minute_2}* pour **{sanction_2}**", color = 0xFF6C00)
			...
			em2 = discord.Embed(title = f"Liste des emprisonnements de {user.name}", description = f"> • Emprisonné le **{jour_1}/{mois_1}/{annee_1}** à *{heure_1}h{minute_1}* pendant ***{duree_1}*** pour **{sanction_1}**", color = 0xFF6C00)
			em3 = discord.Embed(title = f"Liste des warns de {user.name}", description = f"> • Emprisonné le **{jour_1}/{mois_1}/{annee_1}** à *{heure_1}h{minute_1}* pendant ***{duree_1}*** pour **{sanction_1}** \n > • Emprisonné le **{jour_2}/{mois_2}/{annee_2}** à *{heure_2}h{minute_2}* pendant ***{duree_2}*** pour **{sanction_2}**", color = 0xFF6C00)
